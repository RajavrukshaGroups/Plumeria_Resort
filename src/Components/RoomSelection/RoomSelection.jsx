...
const RoomSelection = ({ rooms }) => {
  ...
  console.log(selectedRooms,'selectedRooms inside room ');
  console.log(selectedPlan,'selectedPlannnnnnn')
  ...
  const roomImages = {
    ...
    // console.log(updatedRooms,'updatedRoomsSSSSSSSSS');
  ...
  const handleImageChange = (roomType, direction) => {
    ...
    const handleRoomSelect = (roomType, plan, roomId) => {
      console.log(roomId,'room idddd');
      console.log(rooms,'roomssssssssss');
      if (!roomType || roomId === undefined) return;
  
      let updatedRooms = rooms.filter((room) => room.id !== roomId);
  
      if (plan) {
        console.log(plan,'plan is coming');
